...
test_apps.misc.kv_sign_transition.py"

UV_CACHE_DIR=/tmp/uv-cache uv run core/emu.py \
  --disable-animation \
  --headless \
  --temporary-profile \
  -c pytest tests/device_tests/misc/test_msg_kv_get_authority.py tests/device_tests/misc/test_msg_kv_get_record_id.py tests/device_tests/misc/test_msg_kv_sign_transition.py -q --lang=en
